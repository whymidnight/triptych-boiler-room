...
export const NFTGalleryItems = ({ onSelection }) => {
  ...
  useEffect(() => {
    async function fetchNFTMetadata() {
      ...
      nftsWithMetadata = nftsWithMetadata.filter((item) => item.name !== "");
      ...
      const newItems = {
        ...
        genOneDraggable: nftsWithMetadata
          ...
          .filter((item) => {
            ...
            return (
              quests[questSelection].PairsConfig.LeftCreators.findIndex(
                (whitelistedCM) =>
                  item.metadataAccount.data.data.creators[0].address.toString() ===
                  whitelistedCM
              ) !== -1
            );
          }),
        genTwoDraggable: nftsWithMetadata
          ...
          .filter((item) => {
            return (
              quests[questSelection].PairsConfig.RightCreators.findIndex(
                (whitelistedCM) =>
                  item.metadataAccount.data.data.creators[0].address.toString() ===
                  whitelistedCM
              ) !== -1
            ...
            {stakingProgression === 0 && (
              <QuestStakingTokens
                ...
                required={
                  ...
                  quests[questSelection].PairsConfig
  ...
  return (
    <Box>
      <Grid container alignItems="center" justifyContent="center">
        ...
        <Grid item sx={{ justifyContent: "center" }} xs={12}></Grid>
      </Grid>
      <Grid container>
        <Grid item xs={12}>
          <Typography
            ...
            component="div"
          >
            {props.id}'s Staking ({props.required} Required)
          </Typography>
        </Grid>
      </Grid>
          ...
          >
            ...
            >
              <Typography
                style={{
                  fontSize: "1.9rem",
                  opacity: props.staking.length === 0 ? "1.0" : "0.1",
                }}
                variant="h5"
                component="div"
              >
